...
dbutils.fs.mount(
  source = "abfss://demo@saluciana02.dfs.core.windows.net/",
...
dbutils.fs.mount(
  source = "abfss://raw@saluciana02.dfs.core.windows.net/",
...
dbutils.fs.mount(
  source = "abfss://processed@saluciana02.dfs.core.windows.net/",
  mount_point = "/mnt/formula1dl/processed",
  extra_configs = configs)

# COMMAND ----------

dbutils.fs.mount(
  source = "abfss://presentation@saluciana02.dfs.core.windows.net/",
